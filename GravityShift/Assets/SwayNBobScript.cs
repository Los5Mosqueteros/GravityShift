...
public class SwayNBobScript : MonoBehaviour
{
    ...
    public FirstPersonMovement mover;
    ...
    void BobOffset(){
        ...
        bool grounded = rb != null && rb.linearVelocity.y <= 0;
        
        speedCurve += Time.deltaTime * (grounded ? (Input.GetAxis("Horizontal") + Input.GetAxis("Vertical"))*bobExaggeration : 1f) + 0.01f;
