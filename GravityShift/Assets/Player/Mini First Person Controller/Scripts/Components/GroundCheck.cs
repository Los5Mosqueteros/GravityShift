...
public class GroundCheck : MonoBehaviour
{
    ...
    Vector3 RaycastOrigin => transform.position + transform.up * OriginOffset;
    ...
    void LateUpdate()
    {
        ...
        bool isGroundedNow = Physics.Raycast(RaycastOrigin, -transform.up, distanceThreshold * 2);
    ...
    void OnDrawGizmosSelected()
    {
        ...
        Debug.DrawLine(RaycastOrigin, RaycastOrigin + -transform.up * RaycastDistance, isGrounded ? Color.white : Color.red);
    }
}
